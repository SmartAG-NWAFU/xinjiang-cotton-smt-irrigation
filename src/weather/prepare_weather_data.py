...
class AquaCropWeatherPreparerFuture(AquaCropWeatherPreparer):
    ...
    def _calculate_et0(df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Longwave radiation calculation (optimized)
        ...
        net_lw = surface_emit - df.rlds  # Surface emission minus downwelling longwave
        # Net radiation calculation
    ...
    def _split_system_index(df):
        # Split system_index into two columns
...
def test_results(file_path, year):
    ...
    # Plot Tmin and Tmax on left y-axis
    ...
    # Set main x-axis to show months
