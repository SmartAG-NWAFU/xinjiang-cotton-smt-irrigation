"""Compute average annual temperature, precipitation, and ET0 across sites.

Renamed from `weather_data_change_with_climate_change.py` to
`climate_change_weather_trends.py` for clarity and consistency.
"""
